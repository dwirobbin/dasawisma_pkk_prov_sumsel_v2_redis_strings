<div x-data="modalConfirmBulkDelete" x-on:open-modal.window="open($event)" x-on:close-modal.window="close" x-on:keydown.escape.window="close"
    class="modal modal-blur fade" id="modal-confirm-bulk-delete" tabindex="-1" role="dialog">
            ...
            <div class="modal-footer">
                <div class="w-100">
                    <div class="row">
                        ...
                        <div class="col">
                            <button type="button" wire:click="deleteSelected" class="btn btn-danger w-100">
                                Ya, Hapus
                            </button>
                        </div>
                    </div>
...
@script
    <script>
        Alpine.data('modalConfirmBulkDelete', () => {
            return {
                modalEl: document.getElementById('modal-confirm-bulk-delete'),
                open(e) {
                    ...
                    if (this.modalEl) {
                        this.modalEl.addEventListener('shown.bs.modal', event => {
                            ...
                            modalContent.textContent = `Hapus: ${e.detail.total} Data`;
                        });
                    }
                },
                close() {
