<div>
    <button x-on:click="$dispatch('delete-fm-confirm', { id: '{{ $familyMember?->id }}', name: '{{ $familyMember?->name }}' })"
    ...
    <div wire:ignore.self x-data="modalConfirmDelete" x-on:open-fm-modal.window="open($event)" x-on:close-fm-modal.window="close"
        x-on:keydown.escape.window="close" class="modal modal-blur fade" id="modal-fm-confirm" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                <button type="button" class="btn-close" x-on:click="$dispatch('close-fm-modal')"></button>
                ...
                <div class="modal-footer">
                    <div class="w-100">
                        <div class="row">
                            <div class="col">
                                <button type="button" class="btn w-100" x-on:click="$dispatch('close-fm-modal')">
                                    Batal
                                </button>
                            </div>
                            <div class="col">
...
@script
    <script>
        Alpine.data('modalConfirmDelete', () => {
            return {
                modalEl: document.getElementById('modal-fm-confirm'),
                open(e) {
