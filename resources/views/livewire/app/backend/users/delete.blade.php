<div wire:ignore.self x-data="modalConfirmDelete" x-on:open-modal.window="open($event)" x-on:close-modal.window="close"
    x-on:keydown.escape.window="close" class="modal modal-blur fade" id="modal-confirm" tabindex="-1" role="dialog">
