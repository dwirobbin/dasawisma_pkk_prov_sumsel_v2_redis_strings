<div class="modal modal-blur fade" id="modal-confirm-bulk-delete" tabindex="-1" role="dialog" aria-hidden="true">
...
@script
    <script>
        $wire.on('show-modal-confirm', (data) => {
            const confirmModal = document.getElementById('modal-confirm-bulk-delete');
