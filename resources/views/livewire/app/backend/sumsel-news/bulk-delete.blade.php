<div class="modal modal-blur fade" id="dasawisma-activity-bulk-delete" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-footer">
                <div class="w-100">
                    <div class="row">
                        ...
                        <div class="col">
                            <button type="button" wire:click="deleteSelected" class="btn btn-danger w-100" data-bs-dismiss="modal">
                                Ya, Hapus
                            </button>
                        </div>
                    </div>
...
@script
    <script>
        $wire.on('show-modal-confirm', (data) => {
            const confirmModal = document.getElementById('dasawisma-activity-bulk-delete');
            ...
            if (confirmModal) {
                confirmModal.addEventListener('shown.bs.modal', event => {
                    ...
                    modalContent.textContent = `Hapus: ${data.total} Data`;
                })
            }
        })
    </script>
