                    ...
                    <div class="text-muted my-1 my-lg-0">
                        <label>
                            ...
                            <select class="d-inline-block form-select w-auto" wire:model.live='perPage'>
                                ...
                                @if (count($this->dasawismaActivities))
                                    <option value="{{ $this->dasawismaActivities->total() }}">Semua</option>
                                @endif
                            </select>
                        </label>
                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4" wire:key='{{ $dasawismaActivity->id }}'>
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body p-3">
                                        <h3 class="fs-2 text-body-emphasis mb-1">{{ $dasawismaActivity->title }}</h3>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a wire:navigate href="{{ route('dasawisma_activity.show', $dasawismaActivity->slug) }}"
                                                class="icon-link">
                                                Selengkapnya
                                                <svg class="bi">
                ...
                @if (method_exists($this->dasawismaActivities, 'hasPages'))
                    @if ($this->dasawismaActivities->hasPages())
                        <div class="card-footer pt-1 pb-2 px-3">
                            {{ $this->dasawismaActivities->links() }}
                        </div>
                    @endif
                @endif
