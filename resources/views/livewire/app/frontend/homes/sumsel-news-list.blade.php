<div class="container-xl px-3 px-lg-4 mt-4">
    <div class="row px-2 pb-0 pt-3 mt-5 align-items-center rounded-3 border shadow-lg">
        <div class="col-lg-12">
            <div class="d-flex flex-wrap w-100 align-items-start justify-content-between border-bottom mb-2 pt-0">
                <h2 class>Berita SumSel</h2>
                <a class="icon-link py-1" wire:navigate href="{{ route('sumsel_news.index') }}">
                    Lihat Semua
                    <svg class="bi">
            ...
            <div class="row g-3 pb-3">
                @if (isset($this->sumselNews) && count($this->sumselNews))
                    @foreach ($this->sumselNews as $sumselNews)
                        <div class="col col-md-6 col-lg-4" wire:key='{{ $sumselNews->id }}'>
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <p class="blog-post-meta text-secondary">
                                        ...
                                        <a wire:navigate href="{{ route('sumsel_news.index', ['author' => $sumselNews->username]) }}">
                                            {{ $sumselNews->author }}
                                        </a>
                                    </p>
                                    <p class="card-text">{{ Str::words(strip_tags($sumselNews->body), 12, '...') }}</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a class="icon-link" wire:navigate href="{{ route('sumsel_news.show', $sumselNews->slug) }}">
                                            Selengkapnya
                                            <svg class="bi">
                                                <use xlink:href="#chevron-right"></use>
                                            </svg>
