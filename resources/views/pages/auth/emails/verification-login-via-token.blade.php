                            ...
                            <div class="card card-md">
                                <div class="card-body">
                                    ...
                                    <div class="text-center text-muted">
                                        <p class="fs-h3">
                                            Kami telah mengirimkan tautan login ke email <strong>{{ request()->query('email') }}</strong>.<br />
                                            Silahkan klik tautan tersebut untuk login tanpa password.
                                        </p>
                                        <p class="mt-3">
                                            Email tidak masuk? Periksa folder spam.<br />
                                            Jika tautan tersebut sudah tidak berlaku, klik tombol di bawah ini untuk kembali kehalaman login.
                                        </p>
                                    </div>
                                    <div class="form-footer">
                                        <a wire:navigate href="{{ route('auth.login') }}" class="btn btn-primary w-100">
                                            Kirim Ulang Tautan
                                        </a>
                                    </div>
                                </div>
