            ...
            <main class="container">
                <div class="card rounded-3 border shadow-lg">
                    <div class="card-body row p-3">
                        <div class="col-md-8">
                            <img src="{{ asset($sumselNews->image) }}" alt="Berita {{ $sumselNews->title }}"
                                class="bd-placeholder-img card-img-top rounded-3 object-fit-cover">
                                ...
                                <div class="col-md-12">
                                    <article class="blog-post">
                                        ...
                                        <p class="blog-post-meta">
                                            ...
                                            <a wire:navigate href="{{ url('sumsel-news?author=' . $sumselNews->author->username) }}">
                                                {{ $sumselNews->author->name }}
                                            </a>
                                        </p>

                                        <p class="fs-4 mb-4">
                                            {{ strip_tags($sumselNews->body) }}
                                        </p>
                                    </article>

                                    <livewire:app.frontend.sumsel-news.comment :$sumselNews :key="'comments-' . $sumselNews->id" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="position-sticky" style="top: 2rem;">
                                <div>
                                    <div class="d-flex flex-wrap w-100 align-items-start justify-content-between pt-0">
                                        ...
                                        <a class="icon-link" wire:navigate href="{{ route('sumsel_news.index') }}">
                                            Lihat Semua
                                            <svg class="bi">
                                        ...
                                        @forelse ($moreArticles as $moreArticle)
                                            <li>
                                                <a class="d-flex flex-sm-row flex-wrap flex-lg-nowrap gap-2 align-items-start py-3 link-body-emphasis text-decoration-none border-top"
                                                    wire:navigate href="{{ route('sumsel_news.show', $moreArticle->slug) }}">
                                ...
                                <div class="p-0">
                                    <h4 class="fst-normal">Author</h4>
                                    <ol class="list-unstyled">
                                        @forelse ($moreAuthors as $moreAuthor)
                                            <li>
                                                <a wire:navigate href="{{ url('sumsel-news?author=' . $moreAuthor->username) }}">
                                                    {{ $moreAuthor->author }}
                                                </a>
                                            </li>
                                        @empty
