<x-app-layout>
    <div class="layout-fluid">
            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    <div class="col-6">
                        ...
                        <h2 class="page-title">Kegiatan Dasawisma</h2>
                    </div>
                    @if (auth()->user()->role_id != 3)
                        <div class="col-auto ms-auto">
                            <a wire:navigate href="{{ route('area.dasawisma_activity.create') }}" class="btn btn-primary">
        ...
        <div class="page-body pb-2">
            <div class="container-xl">
                <div class="card">
                    <livewire:app.backend.dasawisma-activities.table lazy />
                </div>
            </div>
        </div>
