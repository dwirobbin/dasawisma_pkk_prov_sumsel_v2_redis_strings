...
class Table extends Component
{
    ...
    public function render(): View
    {
        ...
        ($this->dasawismaActivities()->currentPage() <= $this->dasawismaActivities()->lastPage())
            ? $this->setPage($this->dasawismaActivities()->currentPage())
            : $this->setPage($this->dasawismaActivities()->lastPage());
    ...
    {
        return $this->dasawismaActivities()->pluck('id')->toArray();
    }
